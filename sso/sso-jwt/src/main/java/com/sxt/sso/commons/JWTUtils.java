...
public class JWTUtils {
	...
	private static final String JWT_SECERT = "test_jwt_secert" ;  //自己的一整套系统设置key相同，登录系统通过该key生成token，则别的系统通过该key解析都可以解析出来 parseJWT
	...
	public static void main(String[] args) {
		System.out.println(createJWT(UUID.randomUUID().toString(), "sxt-dfgdgdgtes2t-jwt",
				JWTUtils.generalSubject("hehehedfdheh"), 10*60*1000));
	}
